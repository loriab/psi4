...
void export_mints(py::module& m) {
    ...
    py::classh<CharacterTable>(m, "CharacterTable", "Contains the character table of the point group")
    ...
    py::classh<Libint2ERI>(m, "ERI", pyTwoBodyAOInt, "Computes normal two electron repulsion integrals");
    ...
    py::classh<ThreeCenterOverlapInt>(m, "ThreeCenterOverlapInt", "Three center overlap integrals")
    ...
    py::classh<Localizer>(m, "Localizer", "Class containing orbital localization procedures")
